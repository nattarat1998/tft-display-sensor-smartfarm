...
//==== Creating Objects
UTFT    myGLCD(ILI9341_8,38,39,40,41); //Parameters should be adjusted to your Display/Schield model
...
void drawHomeScreen() {
  ...
  myGLCD.print("Devagro Control Box", CENTER, 10); // Prints the string on the screen
  myGLCD.setColor(255, 0, 0); // Sets color to red
  myGLCD.drawLine(0,32,319,32); // Draws the red line
  myGLCD.setColor(255, 255, 255); // Sets color to white
  myGLCD.setFont(SmallFont); // Sets the font to small
  myGLCD.print("by devagro smart thing", CENTER, 41); // Prints the string
  myGLCD.setFont(BigFont);
  myGLCD.print("Select Program", CENTER, 64);
  ...
  myGLCD.print("DHT22 SENSOR", CENTER, 102); // Prints the string
  ...
  myGLCD.print("PUMP CONTROL", CENTER, 152);
...
void drawDistanceSensor() {
  ...
  myGLCD.setFont(BigFont);
  myGLCD.print("Temp & Humid Sensor", CENTER, 50);
  myGLCD.print("DHT22", CENTER, 76);
  myGLCD.setColor(255, 0, 0);
  ...
  myGLCD.setBackColor(223, 77, 55);
  myGLCD.setColor(255, 255, 255);
  myGLCD.print("RH", 17, 180);
  myGLCD.setBackColor(0, 0, 0);
  myGLCD.setFont(SmallFont);
  myGLCD.print("DHT22 sensor @myroom", CENTER, 220);  
}
//====================================================
...
void getDHT22() {
  ...
  if (selectedUnit == '0') {
    ...
    myGLCD.setBackColor(0, 0, 0);
    myGLCD.printNumI(dht.temperature_C,130, 145, 3,'0');
    myGLCD.setFont(BigFont);
    myGLCD.print("celcius", 235, 178);
  ...
  if (selectedUnit == '1' ) {
    ...
    myGLCD.setColor(0, 255, 0);
    myGLCD.setBackColor(0, 0, 0);
    myGLCD.printNumI(dht.humidity,130, 145, 3,'0');
    myGLCD.setFont(BigFont);
...
void drawGround() {
  ...
  myGLCD.setFont(SmallFont);
  myGLCD.print("Flappy bird game", 140, 220); 
}
